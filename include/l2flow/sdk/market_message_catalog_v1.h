...
inline constexpr std::size_t kProductionMessageCountV1 = 5U;

// The single production catalog. Both the physical SDK subscription and the
// owned-ingress classifier consume this array, so their tuple sets cannot

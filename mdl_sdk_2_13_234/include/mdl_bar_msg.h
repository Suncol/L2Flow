...
enum MDL_BARMessageID {
	...
	MDLMID_MDL_BAR_HFDeriveAlter1 = 123,
	MDLMID_MDL_BAR_HFDeriveAlter2 = 124,
	MDLMID_MDL_BAR_HFDeriveAlter3 = 125
};
...
struct HFDeriveAlter1 {
	enum {
		ServiceID = MDLSID_MDL_BAR,
		ServiceVer = MDLVID_MDL_BAR,
		MessageID = MDLMID_MDL_BAR_HFDeriveAlter1
	};
	MDLAnsiString SecurityID;
	MDLAnsiString ExchangeCD;
	MDLDate TradeDate;
	MDLTime BarTime;
	int64_t DealAmount;
	int64_t DealAmountBuy;
	int64_t DealAmountSell;
	int64_t TurnoverVolBuy;
	int64_t TurnoverVolSell;
	MDLDoubleT<2> TurnoverValueBuy;
	MDLDoubleT<2> TurnoverValueSell;
	MDLDoubleT<8> NetBuyRatio;
	MDLDoubleT<8> NetSellRatio;
	MDLDoubleT<2> NetCommissionValue;
	MDLDoubleT<8> VOI;
	MDLDoubleT<8> OIR;
	MDLDoubleT<8> MPB;
	MDLDoubleT<8> MCI_A;
	MDLDoubleT<8> MCI_B;
	MDLDoubleT<8> MCI_IMB;
	MDLDoubleT<8> MidPrice;
	MDLDoubleT<8> Spread;
	MDLDoubleT<8> SpreadDate;
	MDLDoubleT<8> Commission;
	int64_t CautiousBuy;
	int64_t PositiveBuy;
	MDLDoubleT<8> Pressure;
};

struct HFDeriveAlter2 {
	enum {
		ServiceID = MDLSID_MDL_BAR,
		ServiceVer = MDLVID_MDL_BAR,
		MessageID = MDLMID_MDL_BAR_HFDeriveAlter2
	};
	MDLAnsiString SecurityID;
	MDLAnsiString ExchangeCD;
	MDLDate TradeDate;
	MDLTime BarTime;
	MDLDoubleT<2> ActiveBuyTurnoverValue;
	MDLDoubleT<2> ActiveSellTurnoverValue;
	MDLDoubleT<2> NetActiveTurnoverValue;
	MDLDoubleT<2> BigOrderSellValue;
	MDLDoubleT<2> BigOrderBuyValue;
	MDLDoubleT<8> BigOrderSellRatio;
	MDLDoubleT<8> BigOrderBuyRatio;
	MDLDoubleT<8> BigOrderSellValueLog;
	MDLDoubleT<8> BigOrderBuyValueLog;
	MDLDoubleT<8> BigOrderSellRatioLog;
	MDLDoubleT<8> BigOrderBuyRatioLog;
	MDLDoubleT<8> SellRatioL;
	MDLDoubleT<8> BuyRatioL;
	MDLDoubleT<8> NetBuyRatioL;
	MDLDoubleT<8> OrderRatioL;
	MDLDoubleT<8> SellConcentrate;
	MDLDoubleT<8> BuyConcentrate;
	MDLDoubleT<8> NetBuyConcentrate;
	MDLDoubleT<8> OrderConcentrate;
	int64_t BuyNumber;
	int64_t SellNumber;
	MDLDoubleT<8> ActiveBuyRatio;
	MDLDoubleT<2> ActiveNetBuyValue;
	int64_t SellSubBuy;
	int64_t SellPlusBuy;
	MDLDoubleT<8> WeightedPrice;
	MDLDoubleT<8> BuyActiveRate;
	MDLDoubleT<8> SellActiveRate;
	MDLDoubleT<8> BuyActiveVolRate;
	MDLDoubleT<8> SellActiveVolRate;
	MDLDoubleT<8> BuyLambda;
	MDLDoubleT<8> SellLambda;
	MDLDoubleT<8> LiqElas;
	MDLDoubleT<8> AptEight;
	MDLDoubleT<8> OrderValueMean;
	MDLDoubleT<2> ActiveBuyValueX;
	MDLDoubleT<2> ActiveSellValueX;
	MDLDoubleT<2> ActiveBuyValueL;
	MDLDoubleT<2> ActiveSellValueL;
	MDLDoubleT<2> ActiveBuyValueM;
	MDLDoubleT<2> ActiveSellValueM;
	MDLDoubleT<2> ActiveBuyValueS;
	MDLDoubleT<2> ActiveSellValueS;
};

struct HFDeriveAlter3 {
	enum {
		ServiceID = MDLSID_MDL_BAR,
		ServiceVer = MDLVID_MDL_BAR,
		MessageID = MDLMID_MDL_BAR_HFDeriveAlter3
	};
	MDLAnsiString SecurityID;
	MDLAnsiString ExchangeCD;
	MDLDate TradeDate;
	MDLTime BarTime;
	MDLDoubleT<2> OrderValueXLS;
	MDLDoubleT<2> OrderValueL;
	MDLDoubleT<2> OrderValueM;
	MDLDoubleT<2> OrderValueS;
	MDLDoubleT<2> OrderValueAll;
	MDLDoubleT<2> BuyVal;
	MDLDoubleT<2> SellVal;
};

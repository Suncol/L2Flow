...
enum MDL_SGEMessageID {
	...
	MDLMID_MDL_SGE_GoldPricePlus = 16
};
...
struct GoldNotice {
	...
	MDLDoubleT<6> InitPrice;
	MDLTime BeginTime;
	int64_t TradeVolume;
	MDLDoubleT<6> TradeWeight;
	int64_t BidLot;
	MDLDoubleT<6> BidWeight;
	int64_t AskLot;
	MDLDoubleT<6> AskWeight;
	MDLDoubleT<6> MkiFpPrice;
	MDLAnsiString IsSettlePrice;
	int64_t Rounds;
	MDLTime ApplyTime;
	MDLDoubleT<6> MonthAvgPrice;
...
struct GoldPricePlus {
	enum {
		ServiceID = MDLSID_MDL_SGE,
		ServiceVer = MDLVID_MDL_SGE,
		MessageID = MDLMID_MDL_SGE_GoldPricePlus
	};
	MDLAnsiString MarketID;
	MDLAnsiString InstruID;
	MDLUTF8String InstruName;
